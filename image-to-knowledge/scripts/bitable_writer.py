...
直接复用自 doc-to-knowledge，支持幂等 upsert（通过知识点ID判重）。
"""
...
# 多维表格字段名映射（与 doc-to-knowledge SKILL_SPEC.md §4.1 严格一致）
DEFAULT_FIELD_MAP = {
    "id": "知识点ID",
    "source_doc": "来源文档",
    "source_chapter": "来源章节",
...
def build_record_fields(
    ...
    fields: dict[str, Any] = {
        ...
        fm["source_chapter"]: item.source_chapter,  # 这里是图片名称
        fm["title"]: item.title,
